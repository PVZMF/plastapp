...
export const HomeLan = {
  ...
  footerPhoneNumberSupport: "۰۲۱-۹۱۰۳۰۸۰۹",

  footerLastTitle:
    "کلیه حقوق مادی و معنوی سایت و اپلیکیشن (پلاست اپ) متعلق به شرکت کیان تجارت تام ایرانیان می باشد.",
  headerFooter_Store_Registration: "مراحل ثبت فروشگاه",
  headerFooter_Rule: "قوانین و مقررات",
  headerFooter_About_Us: "پشتیبانی",
  headerFooter_Cradite_Purches: "شرایط خرید اعتباری",
};
