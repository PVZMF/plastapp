...
const Card = ({ index, all, item }) => {
  return (
    <div className={style.card_item}>
        ...
        <h2><IoWalletOutline /> هزینه‌ارسال: <p>{item?.sendPrice > 0 ? item?.sendPrice.toLocaleString('fa-IR') : 'رایگان'}</p></h2>
        <h2><BiTimeFive />  زمان تقریبی ارسال محصول: <p>3 روز کاری</p></h2>
    </div>
  )
}
