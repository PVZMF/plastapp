...
const DetailBlog = ({ title, image, date, description, comments, listLikeBlog }) => {
  return (
...
DetailBlog.defaultProps = {
    ...
    image: ImgBlog,
    date: '1400/03/05',
    description: 'بدون شک لپ‌تاپ‌های سری مک بوک با پردانده M1 جزو بهترین نوت‌بوک‌های دنیا بوده‌اند. اما در سال ۲۰۲۲ اپل از سری جدید لپ‌تاپ‌های خودش با پردازنده M2 رونمایی کرد. در این مطلب می‌خواهیم به طور مشخص به مقایسه مک بوک ایر M1 و مک بوک ایر M2 بپردازیم و ببینیم نسل جدید چقدر ارزش خرید دارد؟'
}